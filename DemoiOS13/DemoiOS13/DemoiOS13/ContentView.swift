                ...
                VStack{
                    MyButton(text: "Demo1")
                        ...
                        .onTapGesture {
                            ...
                            self.manager.showOverlayView{DemoView(width: proxy.size.width * 0.8)}
                        }
                    
                    MyButton(text: "Demo2")
                        .contentShape(Rectangle())
                        .onTapGesture {
                            self.overlayStyle = style1
                            self.manager.showOverlayView{DemoView1()}
                        }
                    
                    MyButton(text: "Demo3")
                        .contentShape(Rectangle())
                        .onTapGesture {
                            self.overlayStyle = style2
                            self.manager.showOverlayView{DemoView2(height: proxy.frame(in: .local).height)}
                        }
                }
                
            }
            .addOverlayContainer(style: self.overlayStyle)
        }
